 ...
 */
public class TransfertExport implements Serializable{
    ...
    public TransfertExport() {

    }

    public TransfertExport(Long id, int nbPassagers, Long navette, String statut, Long conducteur, Calendar dateCreation, Calendar dateDepart, Calendar dateArrivee, Long quaiDepart, Long quaiArrivee) {
